...
namespace Ecole.BusinessEntity
{
    public class StockerBE
    {
        ...
        public int numeroVente { get; set; }
        ...
        public StockerBE(string codeMagasin, string codeArticle, int stockDebut, int quantiteAchetee, int quantiteVendue, DateTime dateOperation,
        ...
        public StockerBE(string codeMagasin, string codeArticle, int stockDebut, int quantiteAchetee, int quantiteVendue, DateTime dateOperation,
            int annee, int puArticle, int stockRestant, int numeroVente)
        {
            CultureInfo ci = CultureInfo.CreateSpecificCulture(CultureInfo.CurrentCulture.Name);
            ci.DateTimeFormat.ShortDatePattern = "dd-MM-yyyy";
            Thread.CurrentThread.CurrentCulture = ci;
