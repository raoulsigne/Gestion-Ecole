...
{
    public class MoyennesTrimestrielsBE
    {
        // définition des attributs -----------------------------------------
        // attribut codeMatière     
        public String codeMat { get; set; }
        
        // attribut codeTrimestre
        ...
        public MoyennesTrimestrielsBE(String codeMatiere, String codeTrimestre, String matricule, Double moyenne, int annee, int rang, double moyenneClasse, string mention, double moyenneMin, double moyenneMax, string appreciation)
        {
