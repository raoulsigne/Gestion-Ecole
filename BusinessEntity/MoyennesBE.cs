...
namespace Ecole.BusinessEntity
{
    public class MoyennesBE
    {
        ...
        public MoyennesBE(String codeMatiere, String codeSequence, String matricule, Double moyenne, int annee, int rang, double moyenneClasse, string mention, double moyenneMin, double moyenneMax, string appreciation)
        {
