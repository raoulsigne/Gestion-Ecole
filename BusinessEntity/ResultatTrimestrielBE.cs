...
{
    public class ResultatTrimestrielBE
    {
        ...
        public ResultatTrimestrielBE(string codeTrimestre, string matricule, int annee, double point, int coef, double moyenne,
